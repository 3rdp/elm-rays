...
var $author$project$State$initialModel = {
	...
	walls: _List_fromArray(
		[
			...
			position: {x: 0, y: 0},
			vector: {
				angle: $elm$core$Basics$degrees(0),
				length: 600
			}
		},
			{
			...
			position: {x: 0, y: 0},
			vector: {
				angle: $elm$core$Basics$degrees(90),
				length: 600
			}
		},
			{
			...
			vector: {
				angle: $elm$core$Basics$degrees(315),
				length: 50
			}
		},
			{
			...
			vector: {
				angle: $elm$core$Basics$degrees(290),
				length: 50
			}
		},
			{
			...
			vector: {
				angle: $elm$core$Basics$degrees(250),
				length: 150
			}
		},
			{
			...
			vector: {
				angle: $elm$core$Basics$degrees(235),
				length: 120
			}
		},
			{
			position: {x: 70, y: 50},
			vector: {
				angle: $elm$core$Basics$degrees(70),
				length: 300
			}
		},
			{
			...
			vector: {
				angle: $elm$core$Basics$degrees(30),
				length: 200
			}
		}
		])
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$State$initialModel, $author$project$State$initialCmd);
};
var $author$project$View$copy = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'text-align', 'center')
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('A raycasting hack in '),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('http://ncase.me/sight-and-light')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('this excellent tutorial')
						])),
					$elm$html$Html$text('.')
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/krisajenkins/elm-rays')
						]),
					_List_fromArray(
						[
...
var $author$project$View$Svg$drawCursor = function (position) {
	return A2(
		$elm$svg$Svg$circle,
		_List_fromArray(
			[
...
var $author$project$Vectors$end = function (line) {
	var _v0 = $elm$core$Basics$fromPolar(
		_Utils_Tuple2(line.vector.length, line.vector.angle));
	var dx = _v0.a;
	var dy = _v0.b;
...
var $author$project$Vectors$start = function ($) {
	return $.position;
};
var $elm$svg$Svg$Attributes$stroke = _VirtualDom_attribute('stroke');
var $author$project$View$Svg$drawTriangle = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$fill('gold'),
				$elm$svg$Svg$Attributes$stroke('gold'),
				...
				A2(
					...
					A2(
						...
						_List_fromArray(
							[
								$author$project$Vectors$start(a),
								$author$project$Vectors$end(a),
								$author$project$Vectors$end(b),
								$author$project$Vectors$start(b)
							]))))
			]),
		_List_Nil);
};
...
var $author$project$View$Svg$neighbours = function (xs) {
	return A3(
		$elm$core$List$map2,
		$elm$core$Tuple$pair,
		xs,
...
var $author$project$Vectors$components = function (line) {
	return {
		dx: $elm$core$Basics$cos(line.vector.angle),
		dy: $elm$core$Basics$sin(line.vector.angle)
	};
};
var $author$project$Vectors$withLength = F2(
	function (length, line) {
		var vector = line.vector;
		return _Utils_update(
			line,
			{
				vector: _Utils_update(
					vector,
					{length: length})
			});
	});
var $author$project$Raycasting$intersect = F2(
	function (ray, target) {
		var wallStart = $author$project$Vectors$start(target);
		var targetComponents = $author$project$Vectors$components(target);
		var rayStart = $author$project$Vectors$start(ray);
		var rayComponents = $author$project$Vectors$components(ray);
		var targetLength = ((((rayStart.x * rayComponents.dy) - (rayStart.y * rayComponents.dx)) + (wallStart.y * rayComponents.dx)) - (wallStart.x * rayComponents.dy)) / ((rayComponents.dy * targetComponents.dx) - (rayComponents.dx * targetComponents.dy));
		var rayLength = ((wallStart.x - rayStart.x) + (targetComponents.dx * targetLength)) / rayComponents.dx;
		return (rayLength < 0) ? $elm$core$Maybe$Nothing : (((targetLength < 0) || (_Utils_cmp(target.vector.length, targetLength) < 0)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			A2($author$project$Vectors$withLength, rayLength, ray)));
	});
...
var $author$project$Raycasting$curtail = F2(
	function (walls, line) {
		return A2(
			...
			A2(
				$elm$core$List$filterMap,
				$author$project$Raycasting$intersect(line),
				walls));
	});
var $author$project$Vectors$addToAngle = F2(
	function (delta, line) {
		var vector = line.vector;
		return _Utils_update(
			line,
...
var $author$project$Vectors$vectorBetween = F2(
	function (p1, p2) {
		var dy = p2.y - p1.y;
		var dx = p2.x - p1.x;
		return {
			angle: A2($elm$core$Basics$atan2, dy, dx),
			length: $elm$core$Basics$sqrt(
				A2($elm$core$Basics$pow, dx, 2) + A2($elm$core$Basics$pow, dy, 2))
		};
	});
var $author$project$Vectors$lineBetween = F2(
	function (from, to) {
		return {
			position: from,
			vector: A2($author$project$Vectors$vectorBetween, from, to)
		};
	});
var $author$project$Raycasting$toRays = F2(
	function (position, line) {
		var rayToStart = A2(
			$author$project$Vectors$lineBetween,
			position,
			$author$project$Vectors$start(line));
		var rayToEnd = A2(
			$author$project$Vectors$lineBetween,
			position,
			$author$project$Vectors$end(line));
		var delta = $elm$core$Basics$degrees(0.1);
		return _List_fromArray(
			[
				A2($author$project$Vectors$addToAngle, delta, rayToStart),
				A2($author$project$Vectors$addToAngle, delta * (-1), rayToStart),
				A2($author$project$Vectors$addToAngle, delta, rayToEnd),
				A2($author$project$Vectors$addToAngle, delta * (-1), rayToEnd)
			]);
	});
var $author$project$Raycasting$solveRays = F2(
	function (position, walls) {
		return A2(
			$elm$core$List$filterMap,
			$author$project$Raycasting$curtail(walls),
			A2(
				$elm$core$List$concatMap,
				$author$project$Raycasting$toRays(position),
				walls));
	});
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$View$Svg$drawRays = F2(
	function (walls, position) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$View$Svg$drawTriangle,
				$author$project$View$Svg$neighbours(
					A2(
						...
						A2(
							$author$project$Raycasting$solveRays,
...
var $author$project$View$Svg$drawLine = function (line) {
	var lineStart = $author$project$Vectors$start(line);
	var lineEnd = $author$project$Vectors$end(line);
	return A2(
		$elm$svg$Svg$line,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$x1(
				$elm$core$String$fromFloat(lineStart.x)),
				$elm$svg$Svg$Attributes$y1(
				$elm$core$String$fromFloat(lineStart.y)),
				$elm$svg$Svg$Attributes$x2(
				$elm$core$String$fromFloat(lineEnd.x)),
				$elm$svg$Svg$Attributes$y2(
				$elm$core$String$fromFloat(lineEnd.y)),
...
var $author$project$View$Svg$drawWalls = function (walls) {
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
...
var $author$project$State$decodeXPosition = A2(
	$elm$json$Json$Decode$at,
	_List_fromArray(
		['clientX']),
	$elm$json$Json$Decode$float);
var $author$project$State$decodeYPosition = A2(
	$elm$json$Json$Decode$at,
	_List_fromArray(
		['clientY']),
	$elm$json$Json$Decode$float);
var $elm$core$Debug$log = _Debug_log;
var $author$project$State$log = function (message) {
	return $elm$json$Json$Decode$map(
		$elm$core$Debug$log(message));
};
...
var $author$project$State$toPositionMsg = F2(
	function (x, y) {
		return $author$project$Types$Change(
			A2($author$project$Vectors$Position, x, y));
	});
var $author$project$State$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onMouseMove(
		A3(
			$elm$json$Json$Decode$map2,
			$author$project$State$toPositionMsg,
